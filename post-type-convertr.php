<?php
/*
Plugin Name: Bulk Convert Post Type
Plugin URI: http://anishlama.com.np
Version: 1.0.2
Author: Anish Blon
Author URI: http://anishlama.com.np
...
License: GPL2
 ...
 Copyright 2011  Anish Blon  (email : anish@76miles.com)
...
function bulk_convert_posts() {
	...
	$q = 'post_author=2&numberposts=-1&post_status=any&post_type='.$_POST['post_type'];	
